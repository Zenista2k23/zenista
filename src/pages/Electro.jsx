...
import "./events.css"
import binary from '../images/eventlogo/ELECTRO.jpeg'
        ...
        <div className="event-details">
            ...
            <div className="bottom">
              ...
              COORDINATORS:
                ...
                <p>1.	M BHUVANESHWAR: <br />8925710139</p>
                <p>2.	NITHYASHREE C :   <br />9962297565</p>
              </div>
              <button className='reg-btn' type="button"><a href="https://forms.gle/Z5eHmmqjZWgVpsUK7" target="_blank"><span class="text">Register</span></a></button> 
            </div>
